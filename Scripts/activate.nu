...
let virtual-env = "D:\Games\нужные приложения(МБ)\Конвертер валют"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\Games\нужные приложения(МБ)\Конвертер валют\Scripts\deactivate.nu"
